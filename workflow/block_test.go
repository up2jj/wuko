...
func TestValidateBlock(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "valid environment", step: Step{Env: Environment{"MODE": "test"}, Steps: []Step{{ID: "run", Type: "shell"}}}},
		{name: "environment empty values", step: Step{Env: Environment{}, Steps: []Step{{ID: "run", Type: "shell"}}}, want: "at least one variable"},
		{name: "environment empty children", step: Step{Env: Environment{"MODE": "test"}, Steps: []Step{}}, want: "at least one step"},
		{name: "environment mixed fields", step: Step{ID: "block", Env: Environment{"MODE": "test"}, Steps: []Step{{ID: "run", Type: "shell"}}}, want: "cannot be combined"},
...
func TestDefinitionValidateStructure(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "environment", steps: []Step{{Env: Environment{"MODE": "test"}, Steps: []Step{step("run")}}}},
