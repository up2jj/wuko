// Package mock_server implements a lifecycle-managed HTTP mock server.
package mock_server
...
func Register(registry *step.Registry) error { return registry.Register("mock_server", New) }
