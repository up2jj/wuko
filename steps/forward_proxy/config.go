// Package forward_proxy implements a lifecycle-managed intercepting HTTP proxy.
...
func Register(registry *step.Registry) error { return registry.Register("forward_proxy", New) }
